...
import { Globe, Bell, Shield, Mail, LogOut, ChevronRight, Smartphone, Download } from "lucide-react";
...
export default function Settings() {
  ...
  const sections = [
    ...
    { 
      ...
      onClick: () => window.open('https://bouchibat.app/privacy', '_blank')
    },
    { 
      icon: Mail, 
      label: t("contact_support"), 
      onClick: () => window.location.href = "mailto:anaaonoo2@gmail.com"
    },
  ];
